...
<form class="formularios" method="post" action="<?= base_url('apartamentos/salva_edicao') ?>" data-toggle="validator" role="form">
    <input type="hidden" name="id_condominio" id="id_condominio" value="<?= $id_condominio ?>">
    <input type="hidden" name="id" value="<?= $apartamento[0]->id ?>">
        ...
        <div class="panel-body">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input id="textNome" value="<?= $apartamento[0]->numero_apartamento ?>" name="numero_apartamento" class="form-control" placeholder=" Digite o número (exemplo 202)" type="text">
                </div>
            </div>
            <?php
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="bloco_selecionado" value="<?= $apartamento[0]->id_bloco ?>">
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">Nome do bloco</div>
                        <input id="nome_bloco" name="nome_bloco" class="form-control" placeholder=" Digite o nome bloco (Somente números)" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
