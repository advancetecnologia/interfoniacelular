...
<div id="faixas_horarios_telefone">
    <div class="text_faixa_horarios">Você deseja cadastrar as faixas de horários que esse telefone aceitará chamadas?
        <button type="button" onclick="inclui_faixas()" class="btn btn-success">Sim</button>
        <button type="button" onclick="window.location = '<?= base_url('telefones') ?>'" class="btn btn-danger">Não</button>
    </div>
    OBS: Se você não cadastrar nenhuma faixa de horário, esse telefone ficará disponível todos os horários.
</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="checkbox">
                ...
                <a onclick="salva_faixa_telefone(<?= $id_telefone ?>)" class="btn btn-success btn-inline">Salvar faixa</a>
            </div>
            <table id="result_table_faixas" class="table table-striped table-faixas">
            </table>
            <button type="button" id="btn_finaliza_cad_faixa_telefone" onclick="window.location = '<?= base_url('telefones/') ?>'" class="btn btn-success">Finalizar cadastro</button>
        </div>
    </div>
    <div class="alert alert-info" role="alert">
        <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Você pode cadastrar diversas faixas de horários
    </div>
</div>
<script>
