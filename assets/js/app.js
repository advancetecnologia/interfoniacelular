    ...
    fix: function () {
        ...
        if ($("body").hasClass("fixed")) {
            ...
            if (window_height >= sidebar_height) {
                var lag = document.getElementById('main').offsetHeight + 100;
                if (lag < window_height) {
                    $(".content-wrapper, .right-side").css('min-height', window_height - 50);
                } else {
                    $(".content-wrapper, .right-side").css('min-height', lag);
                }
